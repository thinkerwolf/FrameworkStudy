...
public class ThreeSumFast {
    ...
    // returns true if the sorted array a[] containsKey any duplicated integers
    ...
    public static void printAll(int[] a) {
        int n = a.length;
        Arrays.sort(a);
        if (containsDuplicates(a)) throw new IllegalArgumentException("array containsKey duplicate integers");
        for (int i = 0; i < n; i++) {
            for (int j = i+1; j < n; j++) {
